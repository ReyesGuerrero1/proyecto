...
urlpatterns = [
    ...
    path('comentario/',views_registros.comentarioContacto, name="comentario"),
    ...
    path('formeditarComentario/<int:id>/',views_registros.editarComentarioContacto,name='Editar'),
